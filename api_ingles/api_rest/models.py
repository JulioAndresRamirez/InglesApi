...
class DataTAV(models.Model):
    #idTAV = models.CharField(primary_key=True, unique=True, max_length=10000)
    run = models.CharField("RUN", max_length=12)
    nombre = models.CharField("Nombre", max_length=255)
    asignatura = models.CharField("Asignatura", max_length=255)
    seccion = models.CharField("Seccion", max_length=255)
    fecha = models.DateField("Fecha")
    hora_inicio = models.CharField("Hora Inicio", max_length=5)
    hora_fin = models.CharField("Hora Fin", max_length=5)
    sala = models.CharField("Sala", max_length=255)
    docente = models.CharField("Proctor", max_length=255)
    #
    created = models.DateTimeField(auto_now=True)
    updated = models.DateTimeField(auto_now_add=True)
    ...
    # TO STRING METHOD
    def __str__(self):
        return 'Run: {0} - Asignatura: {1}'.format(self.run, self.asignatura)
